...
class MediaboxNext(MediaPlayerDevice):
    ...
    def __init__(self, name, username, password, setopid):
        ...
        self._clientId = self.makeId(30)

        self._client = MqttClient(self._clientId, username, password, setopid)
