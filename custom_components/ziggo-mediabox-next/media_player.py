...
from homeassistant.const import CONF_NAME, CONF_HOST, CONF_PORT, CONF_USERNAME, CONF_PASSWORD, CONF_DEVICE_ID
...
def setup_platform(hass, config, add_entities, discovery_info = None):
    ...
    setopid = config[CONF_DEVICE_ID]

    add_entities([MediaboxNext(name, username, password, setopid)], True)